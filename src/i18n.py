...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "ready_status": "Ready",
        "fetching_status": "Fetching video info…",
        "queued_status_one": "Queued {count} video",
        "queued_status_many": "Queued {count} videos",
    ...
    "th": {
        "app_title": "py-tube-downloader",
        "url_placeholder": "วางลิงก์ YouTube วิดีโอหรือเพลย์ลิสต์ที่นี่…",
        ...
        "ready_status": "พร้อม",
        "fetching_status": "กำลังดึงข้อมูลวิดีโอ…",
        "queued_status_one": "เพิ่ม {count} วิดีโอในคิว",
        "queued_status_many": "เพิ่ม {count} วิดีโอในคิว",
